...
void constIteratorTests( void ) {
	...
	}
	{
		...
		vec.push_back( "Hello" );
		vec.push_back( "HellO" );
		ft::vector<std::string>::const_iterator a = vec.begin();
		ft::vector<std::string>::const_iterator b = vec.begin() + 1;
		std::cout << (a == b) << std::endl;
		std::cout << (a != b) << std::endl;
		std::cout << (a != a) << std::endl;
		std::cout << (a == a) << std::endl;
	...
	}
	{
		...
		vec.push_back( 25 );
		vec.push_back( 35 );
		ft::vector<int>::const_iterator a = vec.begin();
		std::cout << *a << std::endl;
		std::cout << *a << std::endl;
		std::cout << "=======================================================" << std::endl;
	}
	...
	}
	{
		...
		vec.push_back( 25 );
		vec.push_back( 35 );
		ft::vector<int>::const_iterator a = vec.end() - 1;
		std::cout << *a << std::endl;
		a--;
		std::cout << *a << std::endl;
		--a;
	...
	}
	{
		...
		vec.push_back( 35 );
		ft::vector<int>::const_iterator a = vec.begin();
		ft::vector<int>::const_iterator b = vec.begin() + 1;
		std::cout << *a << " " << *b << std::endl << std::endl;
		std::cout << (a > b) << std::endl;
		std::cout << (a < b) << std::endl;
		std::cout << (a >= b) << std::endl;
